...
const addCurried = fromPair(add);
const addCurried2 = toPair(fromPair(add));

console.log(addCurried(1, 2), `add(1, 2)`);
console.log(addCurried2([1, 2]), `add([1, 2])`);
